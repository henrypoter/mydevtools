...
<jsp:include page="left.jsp" /> 
		...
		<div class="content">
			<div class="content-inner">
				<h1>XML格式化工具</h1>
				<p>
				格式化XML字符串是开发者经常遇到的问题，XML 在线格式化工具能够方便快捷的帮你完成这个任务。
				</p>
				<p>
					如果你希望了解更多关于xml的知识，请访问 <a href="#json-explained">XML 教程</a> .
				</p>
				<div class="form-wrapper">
					<form id="form" >					
						...
						<div class="buttons">
							<input type="button" class="btn primary" id="formatButton"  value="格式化XML" />
						</div>
					</form>
					<h2>格式化结果：</h2>
...
$(document).ready(function(){
  $("#formatButton").click(function(){
	 ...
	 var inputUrlVal = $("#inputUrl").val();
		$.ajax({
		  type: "POST",
		  url: "${pageContext.request.contextPath}/xmlformat.do",
		  cache: false,
		  data: { sourceType: "xml", input: inputString,inputUrl: inputUrlVal},
